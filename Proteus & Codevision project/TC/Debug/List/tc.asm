...
; 0000 0009 TCNT0=0xB2;
	LDI  R30,LOW(178)
	OUT  0x32,R30
; 0000 000A PORTB.7=~PORTB.7;
	SBIS 0x18,7
	RJMP _0x3
	CBI  0x18,7
	RJMP _0x4
...
; 0000 001A // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 001B DDRB=(1<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(128)
	OUT  0x17,R30
; 0000 001C // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0036 TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	OUT  0x2E,R30
; 0000 0037 TCNT1H=0x00;
	OUT  0x2D,R30
; 0000 0038 TCNT1L=0x00;
	OUT  0x2C,R30
