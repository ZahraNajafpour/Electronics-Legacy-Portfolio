...
; 0000 0031 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0032 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=P Bit0=P
; 0000 0033 PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(3)
	OUT  0x15,R30
; 0000 0034 
...
; 0000 003D // Clock value: 500.000 kHz
; 0000 003E // Mode: Fast PWM top=0xFF
; 0000 003F // OC0 output: Non-Inverted PWM
; 0000 0040 // Timer Period: 0.512 ms
; 0000 0041 // Output Pulse(s):
; 0000 0042 // OC0 Period: 0.512 ms Width: 0.257 ms
; 0000 0043 TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (1<<CS01) | (0<<CS00);
	LDI  R30,LOW(106)
	OUT  0x33,R30
...
; 0000 008F       {OCR0++;
	...
	SUBI R30,-LOW(1)
	OUT  0x3C,R30
; 0000 0090       if(OCR0>250)OCR0=250;
	IN   R30,0x3C
	CPI  R30,LOW(0xFB)
	BRLO _0x7
	LDI  R30,LOW(250)
...
; 0000 0095       {OCR0--;
	...
	SUBI R30,LOW(1)
	OUT  0x3C,R30
; 0000 0096       if(OCR0<10)OCR0=10;
	IN   R30,0x3C
	CPI  R30,LOW(0xA)
	BRSH _0x9
	LDI  R30,LOW(10)
	OUT  0x3C,R30
; 0000 0097       delay_ms(20);
_0x9:
	LDI  R26,LOW(20)
	LDI  R27,0
	CALL _delay_ms
