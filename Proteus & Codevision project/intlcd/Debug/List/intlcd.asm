...
; 0000 000D delay_ms(2);
	CALL SUBOPT_0x0
; 0000 000E if(PIND.0==0) key=7;
	SBIC 0x10,0
	RJMP _0x5
	LDI  R30,LOW(7)
	MOV  R5,R30
; 0000 000F if(PIND.1==0) key=4;
_0x5:
	SBIC 0x10,1
	RJMP _0x6
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 0010 if(PIND.2==0) key=1;
_0x6:
	SBIC 0x10,2
	RJMP _0x7
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 0011 if(PIND.3==0) lcd_clear();
_0x7:
	SBIC 0x10,3
	RJMP _0x8
	CALL _lcd_clear
...
; 0000 0015 delay_ms(2);
	CALL SUBOPT_0x0
; 0000 0016 if(PIND.0==0) key=8;
	SBIC 0x10,0
	RJMP _0xD
	LDI  R30,LOW(8)
	MOV  R5,R30
; 0000 0017 if(PIND.1==0) key=5;
_0xD:
	SBIC 0x10,1
	RJMP _0xE
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 0018 if(PIND.2==0) key=2;
_0xE:
	SBIC 0x10,2
	RJMP _0xF
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 0019 if(PIND.3==0) key=0;
_0xF:
	SBIS 0x10,3
	CLR  R5
; 0000 001A PORTD.5=1;
...
; 0000 001D delay_ms(2);
	CALL SUBOPT_0x0
; 0000 001E if(PIND.0==0) key=9;
	SBIC 0x10,0
	RJMP _0x15
	LDI  R30,LOW(9)
	MOV  R5,R30
; 0000 001F if(PIND.1==0) key=6;
_0x15:
	SBIC 0x10,1
	RJMP _0x16
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 0020 if(PIND.2==0) key=3;
_0x16:
	SBIC 0x10,2
	RJMP _0x17
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 0021 if(PIND.3==0) {lcd_putchar('=');  delay_ms(300);}
_0x17:
	SBIC 0x10,3
	RJMP _0x18
	LDI  R26,LOW(61)
...
; 0000 0025 delay_ms(2);
	CALL SUBOPT_0x0
; 0000 0026 if(PIND.0==0) {lcd_putchar('/');  delay_ms(300);}
	SBIC 0x10,0
	RJMP _0x1D
	LDI  R26,LOW(47)
	CALL SUBOPT_0x1
; 0000 0027 if(PIND.1==0) {lcd_putchar('*');  delay_ms(300);}
_0x1D:
	SBIC 0x10,1
	RJMP _0x1E
	LDI  R26,LOW(42)
	CALL SUBOPT_0x1
; 0000 0028 if(PIND.2==0) {lcd_putchar('-');  delay_ms(300);}
_0x1E:
	SBIC 0x10,2
	RJMP _0x1F
	LDI  R26,LOW(45)
	CALL SUBOPT_0x1
; 0000 0029 if(PIND.3==0) {lcd_putchar('+');  delay_ms(300);}
_0x1F:
	SBIC 0x10,3
	RJMP _0x20
	LDI  R26,LOW(43)
...
; 0000 0040 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0041 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(247)
	OUT  0x1A,R30
; 0000 0042 // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=T Bit2=0 Bit1=0 Bit0=0
...
; 0000 0052 // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0053 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(240)
	OUT  0x11,R30
; 0000 0054 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0055 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0056 
...
; 0000 0086 // INT1: Off
; 0000 0087 // INT2: On
; 0000 0088 // INT2 Mode: Rising Edge
; 0000 0089 GICR|=(0<<INT1) | (0<<INT0) | (1<<INT2);
	IN   R30,0x3B
	ORI  R30,0x20
	OUT  0x3B,R30
; 0000 008A MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(0)
	OUT  0x35,R30
; 0000 008B MCUCSR=(1<<ISC2);
	LDI  R30,LOW(64)
	OUT  0x34,R30
; 0000 008C GIFR=(0<<INTF1) | (0<<INTF0) | (1<<INTF2);
	LDI  R30,LOW(32)
	OUT  0x3A,R30
; 0000 008D 
...
; 0000 00AA // RS - PORTA Bit 0
; 0000 00AB // RD - PORTA Bit 1
; 0000 00AC // EN - PORTA Bit 2
; 0000 00AD // D4 - PORTA Bit 4
; 0000 00AE // D5 - PORTA Bit 5
; 0000 00AF // D6 - PORTA Bit 6
; 0000 00B0 // D7 - PORTA Bit 7
