...
void alcd_write(uint8_t _data, bool _alcd_cmdData)
{
    ...
    Bitchange(__alcd_DB4_Control, __alcd_DB4_Pin, Bitchcke(_data, 4));
    Bitchange(__alcd_DB5_Control, __alcd_DB5_Pin, Bitchcke(_data, 5));
    Bitchange(__alcd_DB6_Control, __alcd_DB6_Pin, Bitchcke(_data, 6));
    Bitchange(__alcd_DB7_Control, __alcd_DB7_Pin, Bitchcke(_data, 7));
    ...
    Bitchange(__alcd_DB4_Control, __alcd_DB4_Pin, Bitchcke(_data, 0));
    Bitchange(__alcd_DB5_Control, __alcd_DB5_Pin, Bitchcke(_data, 1));
    Bitchange(__alcd_DB6_Control, __alcd_DB6_Pin, Bitchcke(_data, 2));
    Bitchange(__alcd_DB7_Control, __alcd_DB7_Pin, Bitchcke(_data, 3));
