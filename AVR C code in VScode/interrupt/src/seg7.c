...
{ 
    ...
    for(forLoopcounter=0; forLoopcounter<=3; forLoopcounter++ )
    {
        ...
        /* 
        داخل این حلقه for اصلی اگر شروع کنیم به نوشت حلقه های متوالی if که تا 9  segment[3] رو پلاس پلاس کنه 
         در اونصورت شمارش از 0 تا 9999 رو انجام دادیم
        */
        ...
        case 0 :
            ...
            Bitset(_7seg_Digit1_control,_7seg_Digit1_Pin );
            Bitclear(_7seg_Digit2_control,_7seg_Digit2_Pin ); 
            Bitclear(_7seg_Digit3_control,_7seg_Digit3_Pin ); 
            Bitclear(_7seg_Digit4_control,_7seg_Digit4_Pin ); 
        break;

        case 1 :
        
            Bitclear(_7seg_Digit1_control,_7seg_Digit1_Pin ); 
            Bitset(_7seg_Digit2_control,_7seg_Digit2_Pin ); 
            Bitclear(_7seg_Digit3_control,_7seg_Digit3_Pin ); 
            Bitclear(_7seg_Digit4_control,_7seg_Digit4_Pin ); 
        ...
        case 2 :
            ...
            Bitclear(_7seg_Digit1_control,_7seg_Digit1_Pin ); 
            Bitclear(_7seg_Digit2_control,_7seg_Digit2_Pin ); 
            Bitset(_7seg_Digit3_control,_7seg_Digit3_Pin ); 
            Bitclear(_7seg_Digit4_control,_7seg_Digit4_Pin ); 
        ...
        case 3 :
            ...
            Bitclear(_7seg_Digit2_control,_7seg_Digit2_Pin ); 
            Bitclear(_7seg_Digit3_control,_7seg_Digit3_Pin ); 
            Bitset(_7seg_Digit4_control,_7seg_Digit4_Pin ); 
